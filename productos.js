...
const LIST = [
  ...
  P('personas', 'Hogar', 'El seguro de hogar (o seguro de casa) protege tu vivienda y todo lo que hay dentro frente a incendio, daños, desastres naturales y hurto. Cotizamos tu póliza de hogar con las principales aseguradoras de hogar de Colombia — seguros para casas, apartamentos y viviendas en general — y te damos tu presupuesto de seguro del hogar online, gratis y por WhatsApp.',
    ...
    ['Propietarios y arrendatarios que quieren cotizar su seguro de casa habitación', 'Quienes buscan seguros para apartamentos, incluso para arrendar apartamento con respaldo', 'Familias que quieren proteger su patrimonio'],
    'También conocido como multirriesgo hogar o seguro de vivienda, es la protección del hogar completa: estructura, contenidos y responsabilidad civil. El cálculo del seguro de hogar depende del valor del inmueble y sus contenidos. Comparamos compañías de seguros de hogar como Seguros Bolívar (hogar y apartamentos), Allianz (seguro hogar), SURA y Mapfre, y si quieres lo combinas con un seguro de vida y hogar para proteger tu patrimonio completo.'),
