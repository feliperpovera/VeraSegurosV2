...
const LIST = [
  ...
  P('personas', 'Hogar', 'El seguro de hogar (o seguro de casa) protege tu vivienda y todo lo que hay dentro frente a incendio, daños, desastres naturales y hurto. Comparamos las principales aseguradoras de hogar de Colombia y te damos tu presupuesto de seguro del hogar online, gratis y por WhatsApp.',
    ...
    ['Propietarios y arrendatarios que quieren cotizar su seguro de casa habitación', 'Familias que quieren proteger su patrimonio'],
    'El cálculo del seguro de hogar depende del valor del inmueble y sus contenidos. Pide tu presupuesto online: cotizamos tu seguro de casa con varias compañías de seguros de hogar sin costo, y si quieres lo combinas con un seguro de vida y hogar para proteger tu patrimonio completo.'),
