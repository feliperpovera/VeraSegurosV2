...
.boton-grande,.boton-pill{display:inline-flex;align-items:center;justify-content:center;gap:8px;min-height:44px;padding:11px 22px;border-radius:980px;background:var(--accent);color:#fff;font-size:17px;font-weight:400;letter-spacing:-.01em;text-decoration:none;transition:background-color .2s ease,transform .1s ease-out}
.boton-grande:hover,.boton-pill:hover{background:var(--accent-press)}
...
table.comp thead img{display:block;margin:4px auto 8px;max-height:28px;max-width:84px;object-fit:contain}
...
.logos img{height:22px;max-width:70px;object-fit:contain}
